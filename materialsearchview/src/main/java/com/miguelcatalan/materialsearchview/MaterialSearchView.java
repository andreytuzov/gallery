    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        public void onClick(View v) {
            if (v == mBackBtn) {
                ...
                closeSearch();
            } else if (v == mLocationBtn && mOnLocationBtnClickListener != null) {
                mOnLocationBtnClickListener.onLocationBtnClick();
            }
        }
    };

    public void setOnLocationBtnClickListener(OnLocationBtnClickListener onLocationBtnClickListener) {
        mOnLocationBtnClickListener = onLocationBtnClickListener;
    }
